...
class appLocalDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'api.grid_generator' => 'getApi_GridGeneratorService',
            'api.match_maker' => 'getApi_MatchMakerService',
    ...
    /**
     * Gets the 'api.grid_generator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ApiBundle\services\GridGenerator A ApiBundle\services\GridGenerator instance
     */
    protected function getApi_GridGeneratorService()
    {
        return $this->services['api.grid_generator'] = new \ApiBundle\services\GridGenerator();
    }

    /**
     * Gets the 'api.match_maker' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ApiBundle\services\MatchManager A ApiBundle\services\MatchManager instance
     */
    protected function getApi_MatchMakerService()
    {
        return $this->services['api.match_maker'] = new \ApiBundle\services\MatchManager($this->get('doctrine'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'rest-api-sudoku-app', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d394edad49e908c7aa2b71b3503d2d26d5078dc4b02bbe0f98411ff59f66ed21');
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler(($this->targetDirs[2].'\\logs/local.log'), 100, true, NULL);
    }
    ...
    {
        $this->services['router'] = $instance = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, ($this->targetDirs[2].'/config/routing_dev.yml'), array('cache_dir' => __DIR__, 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appLocalUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appLocalUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('be029805a8f1e692fba738ef9dbac9bb01996995');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('579b77f0565342.36081896')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.container_class' => 'appLocalDebugProjectContainer',
            ...
            'secret' => 'be029805a8f1e692fba738ef9dbac9bb01996995',
            'locale' => 'en',
            ...
            'kernel.secret' => 'be029805a8f1e692fba738ef9dbac9bb01996995',
            ...
            'router.options.matcher.cache_class' => 'appLocalUrlMatcher',
            'router.options.generator.cache_class' => 'appLocalUrlGenerator',
            'router_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\RouterListener',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => ($this->targetDirs[2].'/config/routing_dev.yml'),
            'router.cache_class_prefix' => 'appLocal',
            ...
            'debug.container.dump' => (__DIR__.'/appLocalDebugProjectContainer.xml'),
